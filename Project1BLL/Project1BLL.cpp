...
glm::mat4 OX1 = glm::mat4(1.0);
glm::mat4 OX2 = glm::mat4(1.0);
glm::mat4 OX3 = glm::mat4(1.0);

float angle_ox1 = 0.0f;
float angle_ox2 = 0.0f;
float angle_ox3 = 0.0f;

//Константы ограничений 
const float MIN_ANGLE_OX2 = -60.0f;
const float MAX_ANGLE_OX2 = 100.0f;
const float MIN_ANGLE_OX3 = -160.0f;
const float MAX_ANGLE_OX3 = 40.0f;
...
int main()
{
    ...
    while (!glfwWindowShouldClose(MyWindow)) {
        ...
        glm::vec3 lightColor;
        lightColor.x = static_cast<float>(0.8);
        lightColor.y = static_cast<float>(0.8);
        lightColor.z = static_cast<float>(0.8);
        ...
        shader.setUniform("light.specular", specularColor);
        ...
        if (!ourRTC.meshes.empty()) {
            ourRTC.Draw(shader, OX1, OX2, OX3);
        }
...
void processInput(GLFWwindow* window) {
    ...
    if (glfwGetKey(window, GLFW_KEY_N) == GLFW_PRESS) {
        ...
        float NewAngle = angle_ox1 - deltaTime * 50;
        OX1 = glm::rotate(glm::mat4(1.0), glm::radians(NewAngle), glm::vec3(0.0, 1.0, 0.0));
        angle_ox1 = NewAngle;
    }
    ...
    if (glfwGetKey(window, GLFW_KEY_H) == GLFW_PRESS) {
        ...
        float NewAngle = angle_ox2 - deltaTime * 50;
        NewAngle = glm::clamp(NewAngle, MIN_ANGLE_OX2, MAX_ANGLE_OX2);
        OX2 = glm::rotate(glm::mat4(1.0), glm::radians(NewAngle), glm::vec3(0.0, 0.0, 1.0));
        angle_ox2 = NewAngle;
    }
    ...
    if (glfwGetKey(window, GLFW_KEY_Y) == GLFW_PRESS) {
        ...
        float NewAngle = angle_ox3 - deltaTime * 50;
        NewAngle = glm::clamp(NewAngle, MIN_ANGLE_OX3, MAX_ANGLE_OX3);
        OX3 = glm::rotate(glm::mat4(1.0), glm::radians(NewAngle), glm::vec3(0.0, 0.0, 1.0));
        angle_ox3 = NewAngle;
    }
